...
var subsetShared_chunk = require('./subset-shared.chunk-DKnBLi_j.js');
...
var WorkerUrl = (typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('subset-worker.chunk-BJ1y_a0I.js', document.baseURI).href)) ? new URL((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('subset-worker.chunk-BJ1y_a0I.js', document.baseURI).href))) : void 0;
if (typeof window === "undefined" && typeof self !== "undefined") {
  self.onmessage = async (e) => {
    switch (e.data.command) {
      case subsetShared_chunk.Commands.Subset:
        const buffer = await subsetShared_chunk.subsetToBinary(
          e.data.arrayBuffer,
          e.data.codePoints
        );
