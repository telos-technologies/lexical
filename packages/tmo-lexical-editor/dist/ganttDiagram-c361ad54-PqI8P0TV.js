...
var linear = require('./linear-HzXmkiPG.js');
var init = require('./init-BeEueZly.js');
...
function labConvert(o) {
  ...
  if (!(o instanceof linear.Rgb)) o = linear.rgbConvert(o);
  var r = rgb2lrgb(o.r),
      g = rgb2lrgb(o.g),
      b = rgb2lrgb(o.b),
...
linear.define(Lab, lab, linear.extend(linear.Color, {
  brighter(k) {
...
linear.define(Hcl, hcl$1, linear.extend(linear.Color, {
  brighter(k) {
...
function hcl(hue) {
  return function(start, end) {
    var h = hue((start = hcl$1(start)).h, (end = hcl$1(end)).h),
        c = linear.nogamma(start.c, end.c),
        l = linear.nogamma(start.l, end.l),
        opacity = linear.nogamma(start.opacity, end.opacity);
    return function(t) {
      start.h = h(t);
      start.c = c(t);
      start.l = l(t);
...
var interpolateHcl = hcl(linear.hue);
...
const setLink = function(ids, _linkStr) {
  ...
  if (index.getConfig().securityLevel !== "loose") {
    linkStr = index.dist.sanitizeUrl(_linkStr);
  }
