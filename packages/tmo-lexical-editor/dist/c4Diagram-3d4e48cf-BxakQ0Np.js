...
var svgDrawCommon08f97a94 = require('./svgDrawCommon-08f97a94-DE_JZ864.js');
...
const drawImage = function(elem, width, height, x, y, link) {
  ...
  imageElem.attr("x", x);
  imageElem.attr("y", y);
  let sanitizedLink = link.startsWith("data:image/png;base64") ? link : index.dist.sanitizeUrl(link);
