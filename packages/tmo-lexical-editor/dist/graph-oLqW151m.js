...
var symbolProto$2 = TmoLexicalEditor.Symbol ? TmoLexicalEditor.Symbol.prototype : undefined,
...
function baseToString(value) {
  ...
  if (TmoLexicalEditor.isSymbol(value)) {
...
function isKey(value, object) {
  ...
  if (type == 'number' || type == 'symbol' || type == 'boolean' ||
      value == null || TmoLexicalEditor.isSymbol(value)) {
    return true;
  }
...
function toKey(value) {
  if (typeof value == 'string' || TmoLexicalEditor.isSymbol(value)) {
    return value;
  }
  var result = (value + '');
...
var spreadableSymbol = TmoLexicalEditor.Symbol ? TmoLexicalEditor.Symbol.isConcatSpreadable : undefined;
...
/** Used to convert symbols to primitives and strings. */
var symbolProto$1 = TmoLexicalEditor.Symbol ? TmoLexicalEditor.Symbol.prototype : undefined,
...
function baseIsMap(value) {
  return TmoLexicalEditor.isObjectLike(value) && index.getTag(value) == mapTag$2;
}
...
function baseIsSet(value) {
  return TmoLexicalEditor.isObjectLike(value) && index.getTag(value) == setTag$2;
}
...
/** Used to convert symbols to primitives and strings. */
var symbolProto = TmoLexicalEditor.Symbol ? TmoLexicalEditor.Symbol.prototype : undefined,
...
function baseIsEqual(value, other, bitmask, customizer, stack) {
  ...
  if (value == null || other == null || (!TmoLexicalEditor.isObjectLike(value) && !TmoLexicalEditor.isObjectLike(other))) {
...
function isStrictComparable(value) {
  return value === value && !TmoLexicalEditor.isObject(value);
}
