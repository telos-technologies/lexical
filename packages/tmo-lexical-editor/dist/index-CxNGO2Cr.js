...
function isFunction(value) {
  if (!TmoLexicalEditor.isObject(value)) {
    return false;
  }
  // The use of `Object#toString` avoids issues with the `typeof` operator
  // in Safari 9 which returns 'object' for typed arrays and other constructors.
  var tag = TmoLexicalEditor.baseGetTag(value);
  return tag == funcTag$1 || tag == genTag || tag == asyncTag || tag == proxyTag;
}

/** Used to detect overreaching core-js shims. */
var coreJsData = TmoLexicalEditor.root['__core-js_shared__'];
...
function baseIsNative(value) {
  if (!TmoLexicalEditor.isObject(value) || isMasked(value)) {
    return false;
  }
...
var WeakMap = getNative(TmoLexicalEditor.root, 'WeakMap');
...
var baseCreate = (function() {
  ...
  return function(proto) {
    if (!TmoLexicalEditor.isObject(proto)) {
      return {};
    }
    if (objectCreate) {
...
function isIterateeCall(value, index, object) {
  if (!TmoLexicalEditor.isObject(object)) {
    return false;
  }
...
function baseIsArguments(value) {
  return TmoLexicalEditor.isObjectLike(value) && TmoLexicalEditor.baseGetTag(value) == argsTag$1;
}
...
var isArguments = baseIsArguments(function() { return arguments; }()) ? baseIsArguments : function(value) {
  return TmoLexicalEditor.isObjectLike(value) && hasOwnProperty$7.call(value, 'callee') &&
...
/** Built-in value references. */
var Buffer$1 = moduleExports$2 ? TmoLexicalEditor.root.Buffer : undefined;
...
function baseIsTypedArray(value) {
  return TmoLexicalEditor.isObjectLike(value) &&
    isLength(value.length) && !!typedArrayTags[TmoLexicalEditor.baseGetTag(value)];
}
...
var freeProcess = moduleExports$1 && TmoLexicalEditor.freeGlobal.process;
...
/* Built-in method references that are verified to be native. */
var Map$1 = getNative(TmoLexicalEditor.root, 'Map');
...
function isPlainObject(value) {
  if (!TmoLexicalEditor.isObjectLike(value) || TmoLexicalEditor.baseGetTag(value) != objectTag$1) {
    return false;
  }
...
/** Built-in value references. */
var Buffer = moduleExports ? TmoLexicalEditor.root.Buffer : undefined,
...
/* Built-in method references that are verified to be native. */
var DataView = getNative(TmoLexicalEditor.root, 'DataView');

/* Built-in method references that are verified to be native. */
var Promise$1 = getNative(TmoLexicalEditor.root, 'Promise');

/* Built-in method references that are verified to be native. */
var Set$1 = getNative(TmoLexicalEditor.root, 'Set');
...
/** Built-in value references. */
var Uint8Array$1 = TmoLexicalEditor.root.Uint8Array;
...
function isArrayLikeObject(value) {
  return TmoLexicalEditor.isObjectLike(value) && isArrayLike(value);
}
...
function baseMergeDeep(object, source, key, srcIndex, mergeFunc, customizer, stack) {
  ...
  if (isCommon) {
    ...
    if (isArr || isBuff || isTyped) {
      ...
      else if (!TmoLexicalEditor.isObject(objValue) || isFunction(objValue)) {
...
function baseMerge(object, source, srcIndex, customizer, stack) {
  ...
  baseFor(source, function(srcValue, key) {
    ...
    if (TmoLexicalEditor.isObject(srcValue)) {
...
var removeMarkdown_1 = dist$1.removeMarkdown = void 0;
/**
...
removeMarkdown_1 = dist$1.removeMarkdown = removeMarkdown;
...
const getText = (element) => {
    ...
    if (element.labelType === "markdown") {
        text = removeMarkdown_1(element.text);
    }
...
(function (module, exports) {
	...
	})(TmoLexicalEditor.commonjsGlobal, (function () {
	  const {
	    entries,
	    setPrototypeOf,
	    isFrozen,
...
var DOMPurify = /*@__PURE__*/TmoLexicalEditor.getDefaultExportFromCjs(purifyExports);
...
const renderKatex = async (text, config2) => {
  ...
  const { default: katex } = await Promise.resolve().then(function () { return require('./percentages-YKFLWNK2-HdVqVAvt.js'); }).then(function (n) { return n.katex; });
...
const loader$m = async () => {
  const { diagram: diagram2 } = await Promise.resolve().then(function () { return require('./c4Diagram-3d4e48cf-BxakQ0Np.js'); });
...
const loader$l = async () => {
  const { diagram: diagram2 } = await Promise.resolve().then(function () { return require('./flowDiagram-66a62f08-Bby9QIfq.js'); });
...
const loader$k = async () => {
  const { diagram: diagram2 } = await Promise.resolve().then(function () { return require('./flowDiagram-v2-96b9c2cf-CvQavhWX.js'); });
...
const loader$j = async () => {
  const { diagram: diagram2 } = await Promise.resolve().then(function () { return require('./erDiagram-9861fffd-B74dVCMc.js'); });
...
const loader$i = async () => {
  const { diagram: diagram2 } = await Promise.resolve().then(function () { return require('./gitGraphDiagram-72cf32ee-CsDGtIkp.js'); });
...
const loader$h = async () => {
  const { diagram: diagram2 } = await Promise.resolve().then(function () { return require('./ganttDiagram-c361ad54-CDMrPCpW.js'); });
...
const loader$g = async () => {
  const { diagram: diagram2 } = await Promise.resolve().then(function () { return require('./infoDiagram-f8f76790-UVLKpSlU.js'); });
...
const loader$f = async () => {
  const { diagram: diagram2 } = await Promise.resolve().then(function () { return require('./pieDiagram-8a3498a8-BBkoqe7O.js'); });
...
const loader$e = async () => {
  const { diagram: diagram2 } = await Promise.resolve().then(function () { return require('./quadrantDiagram-120e2f19-B4Z_gTxx.js'); });
...
const loader$d = async () => {
  const { diagram: diagram2 } = await Promise.resolve().then(function () { return require('./xychartDiagram-e933f94c-XdC6cQPe.js'); });
...
const loader$c = async () => {
  const { diagram: diagram2 } = await Promise.resolve().then(function () { return require('./requirementDiagram-deff3bca-DDKPAKc1.js'); });
...
const loader$b = async () => {
  const { diagram: diagram2 } = await Promise.resolve().then(function () { return require('./sequenceDiagram-704730f1-DvXBypfa.js'); });
...
const loader$a = async () => {
  const { diagram: diagram2 } = await Promise.resolve().then(function () { return require('./classDiagram-70f12bd4-DGuU7Aac.js'); });
...
const loader$9 = async () => {
  const { diagram: diagram2 } = await Promise.resolve().then(function () { return require('./classDiagram-v2-f2320105-D9Z9E6tq.js'); });
...
const loader$8 = async () => {
  const { diagram: diagram2 } = await Promise.resolve().then(function () { return require('./stateDiagram-587899a1-BaUcYmIp.js'); });
...
const loader$7 = async () => {
  const { diagram: diagram2 } = await Promise.resolve().then(function () { return require('./stateDiagram-v2-d93cdb3a-DP4cT-7w.js'); });
...
const loader$6 = async () => {
  const { diagram: diagram2 } = await Promise.resolve().then(function () { return require('./journeyDiagram-49397b02-DXJehwnF.js'); });
...
const loader$5 = async () => {
  const { diagram: diagram2 } = await Promise.resolve().then(function () { return require('./flowchart-elk-definition-4a651766-VzuY9Yxe.js'); });
...
const loader$4 = async () => {
  const { diagram: diagram2 } = await Promise.resolve().then(function () { return require('./timeline-definition-85554ec2-BatkbI-c.js'); });
...
const loader$3 = async () => {
  const { diagram: diagram2 } = await Promise.resolve().then(function () { return require('./mindmap-definition-fc14e90a-BbU3-sPY.js'); });
...
const loader$2 = async () => {
  const { diagram: diagram2 } = await Promise.resolve().then(function () { return require('./sankeyDiagram-04a897e0-DT-e7emz.js'); });
...
const loader$1 = async () => {
  const { diagram: diagram2 } = await Promise.resolve().then(function () { return require('./blockDiagram-38ab4fdb-B6ht7Tx1.js'); });
