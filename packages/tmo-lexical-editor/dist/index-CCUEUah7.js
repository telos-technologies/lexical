...
import { w as isObject$1, z as baseGetTag, A as root$1, y as isObjectLike, C as freeGlobal, o as getDefaultExportFromCjs, q as commonjsGlobal } from './percentages-YKFLWNK2-BpgWzMVa.js';
...
const renderKatex = async (text, config2) => {
  ...
  const { default: katex } = await import('./percentages-YKFLWNK2-BpgWzMVa.js').then(function (n) { return n.G; });
...
const loader$m = async () => {
  const { diagram: diagram2 } = await import('./c4Diagram-3d4e48cf-C1S8ClrF.js');
...
const loader$l = async () => {
  const { diagram: diagram2 } = await import('./flowDiagram-66a62f08-nNrdlSPu.js');
...
const loader$k = async () => {
  const { diagram: diagram2 } = await import('./flowDiagram-v2-96b9c2cf-BXUUlOvl.js');
...
const loader$j = async () => {
  const { diagram: diagram2 } = await import('./erDiagram-9861fffd-i28mK7Lm.js');
...
const loader$i = async () => {
  const { diagram: diagram2 } = await import('./gitGraphDiagram-72cf32ee-Cr0k9yzG.js');
...
const loader$h = async () => {
  const { diagram: diagram2 } = await import('./ganttDiagram-c361ad54-m0yBR3hZ.js');
...
const loader$g = async () => {
  const { diagram: diagram2 } = await import('./infoDiagram-f8f76790-D4eYa9HX.js');
...
const loader$f = async () => {
  const { diagram: diagram2 } = await import('./pieDiagram-8a3498a8-C8JqwpPI.js');
...
const loader$e = async () => {
  const { diagram: diagram2 } = await import('./quadrantDiagram-120e2f19-BRU8p1_N.js');
...
const loader$d = async () => {
  const { diagram: diagram2 } = await import('./xychartDiagram-e933f94c-DklEgFtt.js');
...
const loader$c = async () => {
  const { diagram: diagram2 } = await import('./requirementDiagram-deff3bca-ZNM-iU-_.js');
...
const loader$b = async () => {
  const { diagram: diagram2 } = await import('./sequenceDiagram-704730f1-Cxn-zJ3f.js');
...
const loader$a = async () => {
  const { diagram: diagram2 } = await import('./classDiagram-70f12bd4-rf6vW_RM.js');
...
const loader$9 = async () => {
  const { diagram: diagram2 } = await import('./classDiagram-v2-f2320105-BrDfU6rs.js');
...
const loader$8 = async () => {
  const { diagram: diagram2 } = await import('./stateDiagram-587899a1-Ca1Kedp5.js');
...
const loader$7 = async () => {
  const { diagram: diagram2 } = await import('./stateDiagram-v2-d93cdb3a-PNCTi3SO.js');
...
const loader$6 = async () => {
  const { diagram: diagram2 } = await import('./journeyDiagram-49397b02-DjzS_MGG.js');
...
const loader$5 = async () => {
  const { diagram: diagram2 } = await import('./flowchart-elk-definition-4a651766-Cq7p-YkF.js');
...
const loader$4 = async () => {
  const { diagram: diagram2 } = await import('./timeline-definition-85554ec2-BWBppUmt.js');
...
const loader$3 = async () => {
  const { diagram: diagram2 } = await import('./mindmap-definition-fc14e90a-DtkdB23N.js');
...
const loader$2 = async () => {
  const { diagram: diagram2 } = await import('./sankeyDiagram-04a897e0-DoCSJoMZ.js');
...
const loader$1 = async () => {
  const { diagram: diagram2 } = await import('./blockDiagram-38ab4fdb--JuqYnA7.js');
