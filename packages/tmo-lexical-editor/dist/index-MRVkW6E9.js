...
import { w as isObject$1, z as baseGetTag, A as root$1, y as isObjectLike, C as freeGlobal, o as getDefaultExportFromCjs, q as commonjsGlobal } from './percentages-YKFLWNK2-Cd-ZN6k-.js';
...
const renderKatex = async (text, config2) => {
  ...
  const { default: katex } = await import('./percentages-YKFLWNK2-Cd-ZN6k-.js').then(function (n) { return n.G; });
...
const loader$m = async () => {
  const { diagram: diagram2 } = await import('./c4Diagram-3d4e48cf-QP_PAT-T.js');
...
const loader$l = async () => {
  const { diagram: diagram2 } = await import('./flowDiagram-66a62f08-KDwWXFPP.js');
...
const loader$k = async () => {
  const { diagram: diagram2 } = await import('./flowDiagram-v2-96b9c2cf-Dix4_n1b.js');
...
const loader$j = async () => {
  const { diagram: diagram2 } = await import('./erDiagram-9861fffd-BxjsJXnw.js');
...
const loader$i = async () => {
  const { diagram: diagram2 } = await import('./gitGraphDiagram-72cf32ee-l7kj1Y0r.js');
...
const loader$h = async () => {
  const { diagram: diagram2 } = await import('./ganttDiagram-c361ad54-DjQ2VJGA.js');
...
const loader$g = async () => {
  const { diagram: diagram2 } = await import('./infoDiagram-f8f76790-BlyBxbnx.js');
...
const loader$f = async () => {
  const { diagram: diagram2 } = await import('./pieDiagram-8a3498a8-Dsq3E7q6.js');
...
const loader$e = async () => {
  const { diagram: diagram2 } = await import('./quadrantDiagram-120e2f19-GjMoKvhq.js');
...
const loader$d = async () => {
  const { diagram: diagram2 } = await import('./xychartDiagram-e933f94c-CbnPHdNV.js');
...
const loader$c = async () => {
  const { diagram: diagram2 } = await import('./requirementDiagram-deff3bca-BUVOHJHB.js');
...
const loader$b = async () => {
  const { diagram: diagram2 } = await import('./sequenceDiagram-704730f1-B30GBhW7.js');
...
const loader$a = async () => {
  const { diagram: diagram2 } = await import('./classDiagram-70f12bd4-Bw4cCPI8.js');
...
const loader$9 = async () => {
  const { diagram: diagram2 } = await import('./classDiagram-v2-f2320105-CmDHfiyc.js');
...
const loader$8 = async () => {
  const { diagram: diagram2 } = await import('./stateDiagram-587899a1-C5egySRg.js');
...
const loader$7 = async () => {
  const { diagram: diagram2 } = await import('./stateDiagram-v2-d93cdb3a-Dl8fyG0o.js');
...
const loader$6 = async () => {
  const { diagram: diagram2 } = await import('./journeyDiagram-49397b02-D8ZkIAu7.js');
...
const loader$5 = async () => {
  const { diagram: diagram2 } = await import('./flowchart-elk-definition-4a651766-DJmVZBOJ.js');
...
const loader$4 = async () => {
  const { diagram: diagram2 } = await import('./timeline-definition-85554ec2-B1uSlc2R.js');
...
const loader$3 = async () => {
  const { diagram: diagram2 } = await import('./mindmap-definition-fc14e90a-BizZkArG.js');
...
const loader$2 = async () => {
  const { diagram: diagram2 } = await import('./sankeyDiagram-04a897e0-7L2H7Mqb.js');
...
const loader$1 = async () => {
  const { diagram: diagram2 } = await import('./blockDiagram-38ab4fdb-Dfo_RobJ.js');
