...
var subsetShared_chunk = require('./subset-shared.chunk-S7S5hF--.js');
...
var WorkerUrl = (typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('subset-worker.chunk-DPMAFTRU.js', document.baseURI).href)) ? new URL((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('subset-worker.chunk-DPMAFTRU.js', document.baseURI).href))) : void 0;
