...
var subsetShared_chunk = require('./subset-shared.chunk-28DodTE9.js');
...
var WorkerUrl = (typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('subset-worker.chunk-D8PRYz2R.js', document.baseURI).href)) ? new URL((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('subset-worker.chunk-D8PRYz2R.js', document.baseURI).href))) : void 0;
